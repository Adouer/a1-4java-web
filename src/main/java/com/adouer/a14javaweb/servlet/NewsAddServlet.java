...
@WebServlet(name = "NewsAddServlet", value = "/NewsAddServlet",initParams = {@WebInitParam(name = "maxFileSize", value = "100"), @WebInitParam(name = "deniedFileList", value = "exe,bat,js"), @WebInitParam(name = "addNewsScore", value = "3")})
